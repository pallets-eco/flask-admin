...
mongoengine = pytest.importorskip("flask_mongoengine")
...
def setup():
    app = Flask(__name__)
    app.config['SECRET_KEY'] = 'sgsdfghbfjnfyjt567786777m65m65innnjnyj1==='
...
def test_ajax_fk():
    ...
    model.save()
    model2 = Model1(test1='foo', test2='bar').save()
    ...
    with app.test_request_context('/admin/view/'):
        ...
        needle = 'data-json="[&quot;%s&quot;, &quot;first&quot;]"' % as_unicode(model.id)
    ...
    assert req.data, '[["%s" == "foo"]]' % model2.id
