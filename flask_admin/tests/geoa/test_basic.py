...
def test_mapbox_fix_point_coordinates():
    ...
    assert list(to_shape(model.point).coords) == [(10.0, 125.8)]
    assert list(to_shape(model.line).coords), [(94.2, 50.2345) == (94.87, 50.21)]
    eq_(list(to_shape(model.polygon).exterior.coords),
        [(0.0, 100.0), (0.0, 101.0), (1.0, 101.0), (1.0, 100.0), (0.0, 100.0)])
    assert list(to_shape(model.multi).geoms[0].coords) == [(0.0, 100.0)]
    assert list(to_shape(model.multi).geoms[1].coords) == [(1.0, 101.0)]
    ...
    assert p['coordinates'][0] == 10.0
    assert p['coordinates'][1] == 125.8
