...
class BaseSQLAFilter(filters.BaseFilter):
    ...
    def get_column(self, alias: t.Any) -> Column[t.Any]:
...
class FilterConverter(filters.BaseFilterConverter):
    ...
    def convert(
        self, type_name: str, column: Column[t.Any], name: str, **kwargs: t.Any
    ...
    def conv_string(
        self, column: Column[t.Any], name: str, **kwargs: t.Any
    ) -> list[BaseSQLAFilter]:
