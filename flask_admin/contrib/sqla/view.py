...
class ModelView(BaseModelView):
    ...
    def __init__(
        ...
        self._search_fields: list[tuple[Column[t.Any], t.Any]] | None = None

        self._filter_joins: dict[tuple[bool, t.Any], t.Any] = dict()

        self._sortable_joins: dict[T_COLUMN, list[InstrumentedAttribute[t.Any]]] = (
            dict()
        )
    ...
    def _order_by(
        ...
        query: T_SQLALCHEMY_QUERY,
        joins: dict[tuple[bool, t.Any], t.Any],
        sort_joins: list[InstrumentedAttribute[t.Any]],
        sort_field: InstrumentedAttribute[t.Any] | None,
        sort_desc: bool,
    ...
    def _apply_sorting(
        ...
        if sort_column is not None:
            if sort_column in self._sortable_columns:
                sort_field = t.cast(
                    InstrumentedAttribute[t.Any], self._sortable_columns[sort_column]
                )
                sort_joins = t.cast(
                    list[InstrumentedAttribute[t.Any]],
