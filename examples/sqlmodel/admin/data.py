...
def build_sample_db():
    ...
    with Session(engine) as db_session:
        ...
        for i in range(len(first_names)):
            ...
            user.type = random.choice(AVAILABLE_USER_TYPES)[0]  # type: ignore
            user.first_name = first_names[i]
            user.last_name = last_names[i]
            user.email = first_names[i].lower() + "@example.com"

            user.website = "https://www.example.com"  # type: ignore
        ...
        sample_text = [
            ...
            },
            {
                ...
                "content": (
                    ...
                    "velit, quisquam est, sed quia non numquam eius modi tempora "
            ...
            },
            {
                ...
                "content": (
                    ...
                    "est,  omnis dolorrepellendus. Temporibus autem quibusdam et aut "
        ...
        for user in user_list:
            ...
            post.date = datetime.datetime.now() - datetime.timedelta(days=tmp)  # type: ignore
        ...
        for i in range(5):
            branch = Tree()  # type: ignore
            branch.name = "Branch " + str(i + 1)
            branch.parent = trunk
            db_session.add(branch)
            for j in range(5):
                leaf = Tree()  # type: ignore
